...
static const esp_ble_mesh_client_op_pair_t vnd_op_pair[] = {
    { ESP_BLE_MESH_VND_MODEL_OP_GET, ESP_BLE_MESH_VND_MODEL_OP_STATUS },
...
void example_ble_mesh_send_vendor_message(uint32_t opcode)
{
                                             ...
                                             esp_ble_mesh_model_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_MODEL_OPERATION_EVT:
        if (param->model_operation.opcode == ESP_BLE_MESH_VND_MODEL_OP_STATUS) {
            ...
            temperature = *(uint16_t *)param->model_operation.msg;
            ESP_LOGI(TAG, "Recv 0x%06x, temp_recv %d, time %lldus",
                param->model_operation.opcode, temperature, end_time - start_time);
    ...
    case ESP_BLE_MESH_CLIENT_MODEL_SEND_TIMEOUT_EVT:
        ...
        example_ble_mesh_send_vendor_message(ESP_BLE_MESH_VND_MODEL_OP_GET);
        break;
    default:
        break;
    }
