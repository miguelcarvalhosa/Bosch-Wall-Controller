    ...
    case ESP_BLE_MESH_MODEL_OPERATION_EVT:
        switch(param->model_operation.opcode) {
            case ESP_BLE_MESH_VND_MODEL_OP_GET:
                /* uint16_t temperature = *(uint16_t *)param->model_operation.msg;
                ESP_LOGI(TAG, "Recv 0x%06x, tid 0x%04x", param->model_operation.opcode, tid); */
                ESP_LOGI(TAG, "Recv 0x%06x, temp_atual %d", param->model_operation.opcode,temperature); 
