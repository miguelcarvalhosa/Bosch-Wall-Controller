// pic32_config.h - Configuration File
...
/*    
Configuration Bits
The microcontroller is configured to run with a 80MHz clock and a 40MHz peripheral bus clock.
It must have a 8MHz external crystal connected.
*/
// DEVCFG3
// USERID = No Setting
